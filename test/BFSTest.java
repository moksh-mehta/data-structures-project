...
public class BFSTest {
    ...
    public void testGraph1() {
        ...
        List<Transport> path1 = new BFS<City, Transport>().getPath(graph1,
                graph1.getCityByName("Providence"),
                graph1.getCityByName("New York City"));
        List<Transport> list1 = TC1.mostDirectRoute("Providence",
                "New York City");
        ...
        Assert.assertEquals(path1.get(1).toString(), new Transport(new City("Boston"),
                ...
                267, 50).toString());
        Assert.assertEquals(path1.get(0).getTarget().toString(),
                new City("Boston").toString());
        Assert.assertEquals(list1.size(),2);

        List<Transport> path2 = new BFS<City, Transport>().getPath(graph1,
                graph1.getCityByName("New York City"),
                graph1.getCityByName("Providence"));
        Assert.assertEquals(path2.size(),1);

        List<Transport> path3 = new BFS<City, Transport>().getPath(graph1,
    ...
    public void testGraph2() {
        ...
        List<Transport> path2 = new BFS<City, Transport>().getPath(graph2,
                graph2.getCityByName("Providence"),
                graph2.getCityByName("Boston"));

        Assert.assertEquals(path2,new LinkedList<>());

        List<Transport> path3 = new BFS<City, Transport>().getPath(graph2,
                graph2.getCityByName("Boston"),
                graph2.getCityByName("Providence"));
        ...
        List<Transport> path4 = new BFS<City, Transport>().getPath(graph2,
                graph2.getCityByName("Boston"),
    ...
    public void testGraph3() {
        ...
        List<Transport> path3 = new BFS<City, Transport>().getPath(graph3,
                graph3.getCityByName("Hyderabad"),
                graph3.getCityByName("Chennai"));
        List<Transport> list3 = TC3.mostDirectRoute("Hyderabad",
                "Chennai");

        Assert.assertEquals(path3.size(),2);
        Assert.assertEquals(path3.get(1).getSource().toString(),
                new City("Bangalore").toString());
        Assert.assertEquals(path3.get(0).toString(),
                new Transport(new City("Hyderabad"),
                new City("Bangalore"),TransportType.BUS, 20,
                        60).toString());

        List<Transport> path4 = new BFS<City, Transport>().getPath(graph3,
                graph3.getCityByName("Chennai"),
                graph3.getCityByName("Hyderabad"));
